...
/**
 * CEC 2017 F22 - Composition Function 2 (N = 3).
 *
 ...
 *   1: Rastrigin                          (scale 5.12/100)
 *   2: Griewank, rescaled by 1000/100     (scale 600/100)
 *   3: Schwefel                           (scale 1000/100)
 *
 *   - Composition, non-separable, multiple funnels
 *   - Search domain: [-100, 100]^D
 *   - f_bias = 2200 (F22* = 2200)
 *   - Global minimum: f(x*) = 2200 at x* = component 1's shift vector
 *
 * Supported dimensions: D = 10, 30, 50.
 */
class CEC2017F22 : public Problem {
public:
    CEC2017F22();
