...
class MJSO : public Optimizer {
public:
    MJSO() = default;
    ~MJSO() override = default;
    std::string methodShortName() const override { return "mjso"; }
    std::string methodFullName()  const override { return "Modified Hybrid Differential Evolution JSO"; }
...
private:
    ...
    // Search-state values required by the evaluation-rejection gate.
