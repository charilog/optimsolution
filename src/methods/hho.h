...
public:
    ...
    void configure(const MethodConfig& mc) override {
        ...
        debug_hho_ = mc.getInt("debug_hho", debug_hho_);
        debug_hho_ = parse_int(mc.getStr("debug_hho", std::to_string(debug_hho_)), debug_hho_);
    }
...
private:
    ...
    double      beta_ = 1.5; // Levy exponent
    long long   iter_ = 0;
};
