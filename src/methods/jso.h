...
public:
	...
	std::string methodFullName()  const override { return "Hybrid Differential Evolution JSO"; }
...
private:
    ...
    int pop_init_{0};   // Initial population (read from cfg or from global settings).
    int pop_min_{4};    // Minimum population in LPSR.
